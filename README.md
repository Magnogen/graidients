...
- [x] Network customisation
  - [x] Number of hidden layers, and nodes per layer should be changable
  - [x] A way to change the inputs, like adding a Random value for a dithery effect
  - idk stuff like that
